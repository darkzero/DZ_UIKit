...
public func SYSTEM_VERSION_EQUAL_TO(_ v: String) -> Bool {
    return (UIDevice.current.systemVersion.compare(v, options: NSString.CompareOptions.numeric, range: nil, locale: nil) == .orderedSame);
}
public func SYSTEM_VERSION_GREATER_THAN(_ v: String) -> Bool {
    return (UIDevice.current.systemVersion.compare(v, options: NSString.CompareOptions.numeric, range: nil, locale: nil) == .orderedDescending);
}
public func SYSTEM_VERSION_GREATER_THAN_OR_EQUAL_TO(_ v: String) -> Bool {
    return (UIDevice.current.systemVersion.compare(v, options: NSString.CompareOptions.numeric, range: nil, locale: nil) != .orderedAscending);
}
...
public func DebugLog(_ msg: AnyObject..., file: String = #file, function: String = #function, line: Int = #line, column: Int = #column) {
#if DEBUG
    var str = "";
